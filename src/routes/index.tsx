      ...
      <div className='xl:flex items-start gap-4'>
        <div className='md:flex-1/2'>
          ...
          <p className="text-lg mt-6">
            I'm a junior frontend software engineer.<br />
            I've been working in the
            industry for nearly <strong>4</strong> years and still happy with my job.<br />
            ...
            , as a <strong>L2</strong> Software Engineer, delivering high-quality products to our clients.
          </p>
        </div>
        <div className='md:flex-1/2 overflow-hidden object-contain rounded-md'>
          <Image src="static/images/avatar.jpg" alt="Nam Nguyen" className="h-auto" />
        </div>
      </div>
      {/* Blog Section */}
      <div className='mt-12'>
        ...
        <p className='text-muted-foreground mt-2 text-md'>
          Articles, Insights, Tips, and more
        </p>
        <div className='mt-4'>
